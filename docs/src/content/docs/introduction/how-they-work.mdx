...
For guidance on choosing between agentic and deterministic approaches and evolving workflows over time, see [Workflow Evolution](/gh-aw/guides/workflow-evolution/).
