...
async function ensureAgentRunsIssue() {
  ...
  // Read issue template from file
  const issueTemplatePath = "/opt/gh-aw/prompts/noop_runs_issue.md";
  const parentBodyContent = fs.readFileSync(issueTemplatePath, "utf8");
